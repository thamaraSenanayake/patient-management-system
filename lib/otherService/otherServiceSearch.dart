...
class OtherServiceSearch extends StatefulWidget {
  _OtherServiceSearchState createState() => _OtherServiceSearchState();
}

class _OtherServiceSearchState extends State<OtherServiceSearch> {
...
class _MainConetnState extends State<MainConetn> {
  ...
  void init() async {
    ...
    await getInvestigation(id).then((s) {
      setState(() {
        patients = s;
        returnListTile();
      });
  ...
  void search() async{
    ...
    if (valid == true) {
      ...
      await searchWardPatient(id,_serchKey.currentState.textboxValue).then((s) {
        setState(()  {
          patients = s;
          print(patients);
          returnListTile();
             ...
             onTap: () {
               Navigator.pushReplacement(
                ...
                MaterialPageRoute(          
                  ...
                  builder: (context) => AddReport(patientID:patients[i]["id"] ,description:patients[i]["descrption"],serviceId:patients[i]["serviceId"] ,),
                  // builder: (context) => NurseHomePage(),
              ));
              //  showDialog(context: context, child:  DescripstionDisplay(patientId:patients[i]["id"] ,description: patients[i]["descrption"],serviceId:patients[i]["serviceId"] ,));
             }
