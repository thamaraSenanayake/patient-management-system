        ...
        child: new ListView(
          children: <Widget>[
            ...
            new ListTile(
              ...
              onTap: () {
                 Navigator.of(context).pop();
                 Navigator.of(context).pushReplacement(new MaterialPageRoute(builder: (BuildContext context) => new ChangePassword(type: "normal",)));
              }
            ),
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).pop();
                Navigator.of(context).pushReplacement(new MaterialPageRoute(builder: (BuildContext context) => new ChangeEmail(type: "normal",)));
              }
            ),
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).pop();
                Navigator.of(context).push(new MaterialPageRoute(builder: (BuildContext context) => new ChangeAddress(type: "normal",)));
              }
            ),
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).pop();
                Navigator.of(context).push(new MaterialPageRoute(builder: (BuildContext context) => new ChangeDp(type: "normal",)));
              }
            ),
            new Divider(),
            new ListTile(
                  ...
                  Expanded(
                    child: GestureDetector(
                        ...
                        onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => getData(id: id,status: 'none',),
                            ))),
                  ),
                  Expanded(
                    child: Container(
                          ...
                          Expanded(
                            child:GestureDetector(
                              ...
                              onTap: () => Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => ReportRecoders(id: id),
                                )
                              )
                          ...
                          Expanded(
                            child:GestureDetector(
                              ...
                              onTap: () => Navigator.pushReplacement(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => addChild(type: 'normal',),
                                )
                              )
