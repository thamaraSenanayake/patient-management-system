...
class PharmacistHome extends StatefulWidget {
  _PharmacistHomeHomeState createState() => _PharmacistHomeHomeState();
}

class _PharmacistHomeHomeState extends State<PharmacistHome> {
        ...
        child: new ListView(
          children: <Widget>[
            ...
            new ListTile(
              ...
              onTap: () {
                 Navigator.of(context).pop();
                 Navigator.of(context).pushReplacement(new MaterialPageRoute(builder: (BuildContext context) => new ChangePassword(type: "pharmacist",)));
              }
            ),
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).pop();
                Navigator.of(context).pushReplacement(new MaterialPageRoute(builder: (BuildContext context) => new ChangeEmail(type: "pharmacist",)));
              }
            ),
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).pop();
                Navigator.of(context).push(new MaterialPageRoute(builder: (BuildContext context) => new ChangeAddress(type: "pharmacist",)));
              }
            ),
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).pop();
                Navigator.of(context).push(new MaterialPageRoute(builder: (BuildContext context) => new ChangeDp(type: "pharmacist",)));
              }
            ),
            new Divider(),
            new ListTile(
                  ...
                  Expanded(
                    child: GestureDetector(
                        ...
                        onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => getData(id: id,status: 'pharmacist',),
                            ))),
                  ),
                  Expanded(
                    child: Container(
                          ...
                          Expanded(
                            child:GestureDetector(
                              ...
                              onTap: () => Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => ReportRecoders(id: id,status: 'pharmacist',),
                                )
                              )
                          ...
                          Expanded(
                            child:GestureDetector(
                              ...
                              onTap: () => Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => addChild(type: 'pharmacist',),
                                )
                              )
