...
import 'package:first/ambulance/AmbulanceTrip.dart';
...
class AmbulanceHome extends StatefulWidget {
  _AmbulanceHomeState createState() => _AmbulanceHomeState();
}
        ...
        child: new ListView(
          children: <Widget>[
            ...
            new ListTile(
              ...
              onTap: () {
                 Navigator.of(context).pop();
                 Navigator.of(context).pushReplacement(new MaterialPageRoute(builder: (BuildContext context) => new ChangePassword(type: "ambulance",)));
              }
            ),
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).pop();
                Navigator.of(context).pushReplacement(new MaterialPageRoute(builder: (BuildContext context) => new ChangeEmail(type: "ambulance",)));
              }
            ),
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).pop();
                Navigator.of(context).push(new MaterialPageRoute(builder: (BuildContext context) => new ChangeAddress(type: "ambulance",)));
              }
            ),
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).pop();
                Navigator.of(context).push(new MaterialPageRoute(builder: (BuildContext context) => new ChangeDp(type: "ambulance",)));
              }
            ),
            new Divider(),
            new ListTile(
                  ...
                  Expanded(
                    child: GestureDetector(
                        ...
                        onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => getData(id: id,status: 'ambulance',),
                            ))),
                  ),
                  Expanded(
                    child: Container(
                          ...
                          Expanded(
                            child:GestureDetector(
                              ...
                              onTap: () => Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => ReportRecoders(id: id,status: 'ambulance',),
                                )
                              )
                          ...
                          Expanded(
                            child:GestureDetector(
                              ...
                              onTap: () => Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => addChild(type: 'ambulance',),
                                )
                              )
