...
class addRecordsToAssignPatientSearchPage extends StatefulWidget {
  String doctorId;
  addRecordsToAssignPatientSearchPage({this.doctorId});
  _addRecordsToAssignPatientSearchPageState createState() => _addRecordsToAssignPatientSearchPageState();
}

class _addRecordsToAssignPatientSearchPageState extends State<addRecordsToAssignPatientSearchPage> {
        ...
        child: ListTile(
          leading: CircleAvatar(
             ...
             onTap: () => Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                              builder: (context) => AddRecord(patientID: patients[i]["id"]),
                            )),
