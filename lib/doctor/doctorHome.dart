        ...
        child: new ListView(
          children: <Widget>[
            ...
            new ListTile(
              ...
              onTap: () {
                 Navigator.of(context).pop();
                 Navigator.of(context).pushReplacement(new MaterialPageRoute(builder: (BuildContext context) => new ChangePassword(type: "doctor",)));
              }
            ),
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).pop();
                Navigator.of(context).pushReplacement(new MaterialPageRoute(builder: (BuildContext context) => new ChangeEmail(type: "doctor",)));
              }
            ),
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).pop();
                Navigator.of(context).push(new MaterialPageRoute(builder: (BuildContext context) => new ChangeAddress(type: "doctor",)));
              }
            ),
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).pop();
                Navigator.of(context).push(new MaterialPageRoute(builder: (BuildContext context) => new ChangeDp(type: "doctor",)));
              }
            ),
            new Divider(),
            new ListTile(
                  ...
                  Expanded(
                    child: GestureDetector(
                        ...
                        onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => getData(id: id,status: 'doctor',),
                            ))),
                  ),
                  Expanded(
                    child: Container(
                          ...
                          Expanded(
                            child:GestureDetector(
                              ...
                              onTap: () => Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => ReportRecoders(id: id,status: 'doctor',),
                                )
                              )
                          ...
                          Expanded(
                            child:GestureDetector(
                              ...
                              onTap: () => Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => addChild(type: 'doctor',),
                                )
                              )
