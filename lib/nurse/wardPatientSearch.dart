...
class wardPatientSearch extends StatefulWidget {
  _wardPatientSearchState createState() => _wardPatientSearchState();
}

class _wardPatientSearchState extends State<wardPatientSearch> {
...
class _MainConetnState extends State<MainConetn> {
  ...
  void init() async {
    ...
    await getWardPatient(id).then((s) {
      setState(() {
        patients = s;
        returnListTile();
      });
        ...
        child: ListTile(
          leading: CircleAvatar(
             ...
             onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => nurseGetPatientMedicine(id: patients[i]["id"]),
                            )),
